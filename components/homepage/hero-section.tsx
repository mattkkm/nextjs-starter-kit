...
export default function HeroSection() {
    return (
        <section className='flex flex-col items-center justify-center leading-6 mt-[3rem]' aria-label="DealFinder Hero">
            ...
            <div className="flex justify-center items-center gap-3">
                ...
                <Link
                    ...
                    aria-label="View DealFinder Template on GitHub"
                >
                ...
                <div className="relative flex max-w-6xl justify-center overflow-hidden mt-7">
                    <div className="relative rounded-xl">
                        <Image
                            ...
                            alt="DealFinder Dashboard Preview"
                            width={1100}
                            height={550}
                            priority={true}
                        ...
                        <Image
                            ...
                            width={1100}
                            height={550}
                            alt="DealFinder Dark Mode Dashboard Preview"
                            priority={true}
